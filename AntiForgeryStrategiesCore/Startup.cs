    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton(serviceProvider =>
            {
                ...
                if (antiforgeryAdditionalDataProviderType == null)
                {
                    throw new Exception($"Type not found: {antiforgeryAdditionalDataProviderTypeStrongName}");
                }

                return (IAntiforgeryAdditionalDataProvider) Activator.CreateInstance(antiforgeryAdditionalDataProviderType);
            });
